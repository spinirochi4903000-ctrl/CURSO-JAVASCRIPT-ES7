...
const nu = null; // null valor intenconalmente vacio
...
console.log(typeof null);// object (es un error historico de JavaScript)
...
// use let cuando necesites reasignar un valor
...
console.log("m" + 3);
console.log("5" - 3);// 2 (correcion a number)
